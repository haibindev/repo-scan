...
> Claude Code 技能：全面的源码资产审计工具。重构之前，先摸清家底。
...
- Python 3.6+
- [Claude Code](https://docs.anthropic.com/en/docs/claude-code)（用于调用技能）
- Git（可选，用于活跃度分析）

## 致谢

本项目基于 [Claude Code](https://docs.anthropic.com/en/docs/claude-code) 构建，由 [Anthropic](https://www.anthropic.com/) 提供支持。
